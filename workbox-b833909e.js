define(["exports"], (function(t) {
    ...
    function x(t) {
        ...
        : function(e, ...s) {
            ...
            return b.set(n, e.sort ? e.sort() : [e]),
            I(n)
        }
    }
    function L(t) {
        ...
        e = t,
        (g || (g = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some((t => e instanceof t)) ? new Proxy(t,U) : t);
        var e
    }
    function I(t) {
    ...
    class T {
        ...
        async getDb() {
            return this.h || (this.h = await function(t, e, {blocked: s, upgrade: n, blocking: i, terminated: r}={}) {
    ...
    class j {
        ...
        async delete() {
            this.v = !1,
            await this._.expireEntries(1 / 0)
        }
    }
    try {
    ...
    class P {
        ...
        isResponseCacheable(t) {
            let e = !0;
            return this.L && (e = this.L.includes(t.status)),
    ...
    class Y {
        ...
        precache(t) {
            ...
            this.J || (self.addEventListener("install", this.install),
    ...
    t.CacheableResponsePlugin = class {
        constructor(t) {
            this.cacheWillUpdate = async ({response: t}) => this.X.isResponseCacheable(t) ? t : null,
            this.X = new P(t)
        }
    }
    ,
