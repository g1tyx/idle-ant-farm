if (!self.define) {
  ...
  self.define = (i, o) => {
    ...
    s[r] = Promise.all(i.map((e) => a[e] || t(e))).then((e) => (o(...e), c));
  };
}
define(["./workbox-b833909e"], function (e) {
  ...
  self.skipWaiting(),
    ...
    e.precacheAndRoute(
      [
        { url: "assets/index-CyRhWWj0.css", revision: null },
        { url: "assets/index-oCbxJhH0.js", revision: null },
        { url: "assets/workbox-window.prod.es5-B9K5rw8f.js", revision: null },
        { url: "index.html", revision: "395a43658d4dd911538e1a5dae3c6fca" },
        {
